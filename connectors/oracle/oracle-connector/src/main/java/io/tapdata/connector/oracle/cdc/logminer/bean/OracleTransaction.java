...
public class OracleTransaction {
    ...
    public OracleTransaction(String rsId, long scn, String xid, Map<String, List<RedoLogContent>> redoLogContents) {
        this.rsId = rsId;
        this.scn = scn;
        this.xid = xid;
    ...
    public OracleTransaction(String rsId, long scn, String xid, Map<String, List<RedoLogContent>> redoLogContents, Long firstTimestamp) {
        this.rsId = rsId;
        this.scn = scn;
        this.xid = xid;
        this.redoLogContents = redoLogContents;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("OracleTransaction{");
        sb.append("rsId='").append(rsId).append('\'');
        sb.append(", scn=").append(scn);
        sb.append(", xid='").append(xid).append('\'');
        sb.append(", redoLogContents=").append(redoLogContents);
        sb.append('}');
        return sb.toString();
    }
}

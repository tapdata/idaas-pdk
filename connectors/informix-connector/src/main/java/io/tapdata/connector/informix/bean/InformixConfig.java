 ...
 * @date 2022/4/18
 */
public class InformixConfig implements Serializable {

    private static final long serialVersionUID = 1L;

    private String jdbcDriver = "com.mysql.jdbc.Driver"; // mysql>8.0
    ...
    public static InformixConfig load(String jsonFile) throws IOException {
        ObjectMapper mapper = new ObjectMapper(new JsonFactory());
        return mapper.readValue(new File(jsonFile), InformixConfig.class);
    }
     ...
     */
    public static InformixConfig load(Map<String, Object> map) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue((new ObjectMapper()).writeValueAsString(map), InformixConfig.class);
    }

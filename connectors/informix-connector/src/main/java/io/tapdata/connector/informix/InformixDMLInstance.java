...
public class InformixDMLInstance {
    private final SimpleDateFormat tapDateTimeFormat = new SimpleDateFormat();
    private static final InformixDMLInstance DMLInstance = new InformixDMLInstance();

    public static InformixDMLInstance getInstance() {
        return DMLInstance;
    }

 ...
 * @date 2022/4/18
 */
public class Mysql8Config implements Serializable {
    ...
    public static Mysql8Config load(String jsonFile) throws IOException {
        ObjectMapper mapper = new ObjectMapper(new JsonFactory());
        return mapper.readValue(new File(jsonFile), Mysql8Config.class);
    }
     ...
     */
    public static Mysql8Config load(Map<String, Object> map) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue((new ObjectMapper()).writeValueAsString(map), Mysql8Config.class);
    }

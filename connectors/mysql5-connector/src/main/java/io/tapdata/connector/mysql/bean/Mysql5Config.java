 ...
 * @date 2022/4/18
 */
public class Mysql5Config implements Serializable {
    ...
    public static Mysql5Config load(String jsonFile) throws IOException {
        ObjectMapper mapper = new ObjectMapper(new JsonFactory());
        return mapper.readValue(new File(jsonFile), Mysql5Config.class);
    }
     ...
     */
    public static Mysql5Config load(Map<String, Object> map) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue((new ObjectMapper()).writeValueAsString(map), Mysql5Config.class);
    }

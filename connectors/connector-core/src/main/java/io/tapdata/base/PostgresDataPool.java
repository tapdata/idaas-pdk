...
public class PostgresDataPool {
    ...
    public static PostgresJdbcContext getJdbcContext(PostgresConfig postgresConfig) {
        String key = uniqueKeyForDb(postgresConfig);
    ...
    public static void removeJdbcContext(PostgresConfig postgresConfig) {
        dataPool.remove(uniqueKeyForDb(postgresConfig));
    }

    private static String uniqueKeyForDb(PostgresConfig postgresConfig) {
        return postgresConfig.getHost() + postgresConfig.getPort() + postgresConfig.getDatabase() + postgresConfig.getSchema();
    }

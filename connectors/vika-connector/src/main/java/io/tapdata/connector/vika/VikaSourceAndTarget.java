...
import io.tapdata.pdk.apis.entity.ddl.*;
...
public class VikaSourceAndTarget extends ConnectorBase implements TapTarget, TapSource {
     ...
     */
    @Override
    public void discoverSchema(TapConnectionContext connectionContext, TapListConsumer<TapTableOptions> tapReadOffsetConsumer) {

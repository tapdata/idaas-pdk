...
public class RedoLogContent {
    ...
    public RedoLogContent(Map<String, Object> logData) throws SQLException {
        ...
        this.rollback = logData.get("ROLLBACK") == null ? 0 : Integer.valueOf(logData.get("ROLLBACK").toString());
        this.thread = logData.get("THREAD#") == null ? 0 : Integer.valueOf(logData.get("THREAD#").toString());
    ...
    public RedoLogContent(Map<String, Object> logData, Map<Long, String> tableObjectId) throws SQLException {
        this.scn = logData.get("SCN") == null ? null : Long.valueOf(logData.get("SCN").toString());
        this.operation = logData.get("OPERATION") == null ? "" : logData.get("OPERATION").toString();
        this.timestamp = logData.get("TIMESTAMP") == null ? null : new Timestamp(((Date) logData.get("TIMESTAMP")).getTime());
        this.status = logData.get("STATUS") == null ? null : Long.valueOf(logData.get("STATUS").toString());
    ...
    public static String id(Integer thread, String xid, Long scn, String rsId, Long ssn, Integer csf, String sqlRedo) {
        return new StringBuilder(thread).append(ID_DELIM)
                .append(xid).append(ID_DELIM)
                .append(scn).append(ID_DELIM)
                .append(rsId).append(ID_DELIM)
                .append(ssn).append(ID_DELIM)
                .append(csf).append(ID_DELIM)
                .append(sqlRedo)
                .toString();
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("RedoLogContent{");
        sb.append("scn=").append(scn);
        sb.append(", operation='").append(operation).append('\'');
        sb.append(", operationCode=").append(operationCode);
        sb.append(", timestamp=").append(timestamp);
        sb.append(", status=").append(status);
        sb.append(", sqlRedo='").append(sqlRedo).append('\'');
        sb.append(", sqlUndo='").append(sqlUndo).append('\'');
        sb.append(", rowId='").append(rowId).append('\'');
        sb.append(", tableName='").append(tableName).append('\'');
        sb.append(", rsId='").append(rsId).append('\'');
        sb.append(", ssn=").append(ssn);
        sb.append(", xid='").append(xid).append('\'');
        sb.append(", segOwner='").append(segOwner).append('\'');
        sb.append(", csf=").append(csf);
        sb.append(", undoOperation='").append(undoOperation).append('\'');
        sb.append(", undoOperationCode=").append(undoOperationCode);

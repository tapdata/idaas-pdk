...
public class LobWriteUtil {
    ...
    public static boolean isLobWrite(String operation) {
        return OracleConstant.REDO_LOG_OPERATION_LOB_TRIM.equals(operation)
            ...
            for (RedoLogContent content : entry.getValue()) {
                if (LobWriteUtil.isLobWrite(content.getOperation())) {
                    ...
                    if (null == lastContent || lastContent.getScn() != content.getScn()) {
                        ...
                        lastContent.setOperation(OracleConstant.REDO_LOG_OPERATION_UPDATE);
                    ...
                    if (StringUtils.containsAny(content.getOperation(), OracleConstant.REDO_LOG_OPERATION_INSERT, OracleConstant.REDO_LOG_OPERATION_UPDATE)) {
                        lastContent = content;
                    }

...
public class DateTimeColumnHandler {
    ...
    Object getTimestampWithTimezoneField(String columnValue, String actualType) {
        if (columnValue == null) {
            return null;
        }
        ...
        if (m.find()) {
            ...
            String dateFormat = DateUtil.determineDateFormat(dateString);
            if (StringUtils.isNotBlank(dateFormat)) {
                dateFormat = dateFormat.substring(0, dateFormat.length() - 2);
    ...
    Object getTimestampWithLocalTimezone(String columnValue, String actualType) {
        if (columnValue == null) {
            return null;
        }
